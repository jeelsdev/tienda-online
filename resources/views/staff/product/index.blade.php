                                        ...
                                        <div class="flex justify-between lg:w-1/3">
                                            <div class="w-1/2">
                                                <x-select id="search-category" name="category" class=" w-full h-10">
                                                    <option {{ request('category') == '' ? 'selected':'' }} value="" >todas las categorias</option>
                                            ...
                                            <div class="w-1/2 ml-2">
                                                <x-select id="search-status" name="status" class=" w-full">
                                                    <option {{ request('status') == '' ? 'selected':'' }} value="" >Todos los estados</option>
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <x-link href="{{ route('staff.product.show', ['product'=>$product]) }}"><i class="fa-solid fa-eye fa-lg"></i></x-link>
                                        <x-link href="{{ route('staff.product.edit', ['product'=>$product]) }}"><i class="fa-solid fa-pen-to-square fa-lg"></i></x-link>
                                    </td>
