            ...
            <div class="w-full lg:w-8/12 px-4 mt-24">
                <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg  border-0">
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        <form action="{{ route('staff.store.update', ['store'=>$store]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="flex flex-wrap">
                                <div class="w-full lg:w-12/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <x-textarea name="description">{{ $store->description }}</x-textarea>
                                        @error('description')
                                            <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="flex justify-between">
                                <x-link href="{{ route('staff.store') }}">cancelar</x-link>
