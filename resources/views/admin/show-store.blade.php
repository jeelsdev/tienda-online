                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        <form>
                            ...
                            <div class="flex flex-wrap">
                                <div class="w-full lg:w-12/12 px-4">
                                    <div class="relative w-full mb-3">
                                        <x-input type="text" value="{{ $direction->direction }}" disabled="true" class="border-none"></x-input>
                                    </div>
                                </div>
                                <div class="w-full lg:w-4/12 px-4">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <x-input type="text" value="{{ $direction->department->name }}" disabled="true" class="border-none"></x-input>
                                    </div>
                                </div>
                                <div class="w-full lg:w-4/12 px-4">
                                    <div class="relative w-full mb-3">
